 ...
 */
public class ADMTPick extends ItemPickaxe{


    public ADMTPick(String unlocalizedName, Item.ToolMaterial material)
    {
        super(material);
        setRegistryName("admtpick");        // The unique name (within your mod) that identifies this item
        setUnlocalizedName(ModEvAdamant.MODID + ".admtpick");     // Used for localization (en_US.lang)
